//  •═══════··══════════════════·═══════════════════··══════════════════·═══════════════════··═══════════•
//  ✨λ n3_gen_gen_trait_a1.rs  generics § traits    ι✧22․06․22✦07․49․56․  🌎η ✧22․07․04․ ✧22․06․28․ ✧22․06․24․
#![allow(dead_code)]
use std::error::Error;
...
pub fn check_mod() -> Result<(), Box<dyn Error>> {
    print!("{}🎡ꮗ Testing n3_gen_gen_trait_a1.rs \n\n", C_LL);
    ...
    print!("\n🎡ꮗ Next, printing mult for all variables (1..4) that implement CanFoldTr \n\n");
