...
pub fn check_mod() -> Result<(), Box<dyn Error>> {
    print!("{}🎡𐡋 Checking: p5_trait_iter_a3.rs \n\n", C_LL);

    print!("🎡𐡋 Checking: iterator consume vec of ints \n");
    ...
    print!("🎡𐡋 Checking: iterator consume string of utf8 chars \n");
    let s1 = String::from("A⼏α , A💎α , A->C:, Bβ0» , B📚β , C🈳ψ , ═══ ");
    ...
    print!("🎡𐡋 Checking: same as before but with index \n");
    let s1_iter = s1.chars();
    print!("    ");
