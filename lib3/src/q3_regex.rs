// •════════··══════════════════·═══════════════════··══════════════════·═══════════════════··══════════════════·═══════════════════··═══════════•
// ✨λ lib3::q3_regex sysops_exec  ι✧21․11․22✦10․08․26․ 🌎η ✧22․11․12․✧22․10․22․✧22․08․19․✧22․04․21․✧21․12․15․
#![allow(dead_code)]
extern crate regex;
use regex::Regex;
...
fn remove_2_multiline_quotes(ss: String) -> String {
    ...
    let res = RE_2_REMOVE_MULTILINE_QUOTES.replace_all(&ss, "≺1:$yes1≻,--rem-qt-fld--,≺2:$yes2≻");
    res.to_string()
}
...
///λ check int-tests lib3's q3_regex module 
